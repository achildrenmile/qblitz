                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      <span className="font-semibold text-white">{erfolg.titel}</span>
                      {erfolg.selten && (
                    ...
                    <div className="text-sm text-slate-400">{erfolg.beschreibung}</div>
                  </div>
                  {erfolg.punkte > 0 && (
            ...
            {gesperrteErfolge.map(erfolg => (
              <Card key={erfolg.id} variant="solid" padding="sm" className="opacity-60">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      <span className="font-semibold text-slate-400">{erfolg.titel}</span>
                      {erfolg.selten && (
                        <span className="text-xs px-2 py-0.5 bg-slate-700 text-slate-500 rounded">
                          {texte.statistik.selten}
                        </span>
                      )}
                    </div>
                    <div className="text-sm text-slate-500">{erfolg.beschreibung}</div>
                  </div>
                  {erfolg.punkte > 0 && (
