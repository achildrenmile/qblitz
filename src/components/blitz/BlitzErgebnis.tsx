    ...
    <div className="min-h-screen flex flex-col safe-bottom">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4">
        ...
        <div className="text-center mb-8">
          <div className="text-6xl font-bold text-white mb-1">{punkte}</div>
          <div className="text-slate-400">{texte.blitz.punkte}</div>
        </div>
        ...
        <Card variant="glass" className="w-full max-w-sm mb-8">
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              <div className="text-2xl font-bold text-white">{gesamt}</div>
              <div className="text-xs text-slate-400">Fragen</div>
            </div>
            <div>
